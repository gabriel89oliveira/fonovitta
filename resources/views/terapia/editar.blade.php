							...
							<div class="form-wrap">
								...
								@role('Fonoaudiologia_Coordenacao')
									...
									<div class="form-group mr-15">
										...
										{{ Form::select('usuario', $usuarios, $terapia->id_usuario, ['placeholder' => 'Escolher', 'class' => 'form-control']) }}
									</div>
									...
									<div class="form-group">
										...
										{{ Form::select('qualidade_evolucao', [
												'Bom'   => 'Bom', 
												'Ruim'	=> 'Ruim'
											], $qualidade->qualidade, ['placeholder' => 'Escolher', 'class' => 'form-control']) }}
									</div>
									...
									<div class="form-group">
										...
										{{ Form::select('falhas_evolucao', [
												...
												'Nenhum'				=> 'Nenhum'
											], $qualidade->falhas, ['placeholder' => 'Escolher', 'class' => 'form-control']) }}
									</div>
								...
								@else
									...
									{{ Form::hidden('usuario', $terapia->id_usuario) }}
